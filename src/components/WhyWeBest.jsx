...
function WhyWeBest() {
  return (
     <div className='px-[110px] pl-[15vw] flex  h-[80vh] relative'>
        <div className='  w-[35%] h-[100%] rounded-[20px] bg-[#FFA31833]'>
                <img src={clayMakup} alt="laptop image"  className='h-[68vh] absolute z-1 top-10 left-0'/>
        </div>
        <div className='px-[40px] flex flex-col justify-center items-start  w-[75%] h-[100%] gap-3'>
                ...
                <div className=' h-[45vh] w-[100%] p-[10px]'>
