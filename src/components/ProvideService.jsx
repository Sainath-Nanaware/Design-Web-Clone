...
function ProvideService() {
  return (
    <div className='px-[110px] flex  h-[80vh] relative'>
        {/* left text div */}
      <div className='px-[60px] flex flex-col justify-center items-start  w-[65%] h-[100%] gap-3'>
        <p className=' text-[38px] w-[28vw] font-bold '>We provide that service.</p>
      ...
      {/* right cards div */}
      <div className=' w-[45%] h-[100%] rounded-[20px] bg-[#2FB8E333]'>
